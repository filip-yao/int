...
{ id: 1, image: '/Slidshow_graphic/Logo.png', title: 'Redesign loga pro technologickou firmu', description: 'Moderní a minimalistický přístup k firemní identitě' },
{ id: 2, image: '/Slidshow_graphic/Branding.png', title: 'Kompletní branding pro startup', description: 'Vytvoření vizuální identity od základů' },
];

const graphicStyles = ['Minimalistický', 'Ilustrativní', 'Typografický', '3D', 'Retro'];
